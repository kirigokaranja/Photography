            ...
            <div class="panel-heading" style="padding: 0px; width: 100%">
                <div style="padding-top: 2px; ">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#rejected" data-toggle="tab" style="float: left; height: 100%;">Rejected</a></li>
                    </ul>
                    <div class="tab-content ">
                        <div id="works"  style="padding: 10px 20px" class="tab-pane fade">
                            ...
                            $sql = "SELECT * FROM customer_upload 
                                    ...
                                    ORDER BY timePosted DESC, datePosted DESC ";
                        ...
                        <div id="completed"  style="padding: 10px 20px" class="tab-pane fade">
                            <h1><?php echo $id. "Burger";  ?> </h1>
                        </div>
                        <div id="rejected"  style="padding: 10px 20px" class="tab-pane fade">
                            <h1><?php echo $id. "Burger";  ?> </h1>
                        </div>
